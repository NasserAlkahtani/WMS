...
$Dsc = array("Almarai 1L low fat milk","Soft drink from cocacola 355ml", "soft drink from Pepsi 350ml" , "Nofa water 2L","Alblad Low fat laban 2L","Lusien brown bread 10g","freash Tuna fish 200g","Abo kas 2kg white rice","2 Freash Fish ","Kelloggs Corn flex 750g"
,"Apple Iphone x 250gb 8GB RAM", "Apple macbookPro i5 250 gb 8gb RAM","Apple macbookAir i7 250 gb 16gb RAM","NVIDIA GeForce GTX 1080","DELL lattiude-95579 i7 250 gb 16gb RAM","LG ULTRA WIDE TV 120fps 4K","Benq TV 60fps 1080p","Samsuing Galaxy S8 8GB RAM andriod","Google pixel3 8GB RAM andriod");
$loc = array("R1S3","R2S5","R3S1","R4S7","R5S1","R6S9","R8S3","R9S2","R10S1","R1S3","R2S5","R3S1","R4S7","R5S1","R6S9","R8S3","R9S2","R10S1");
$Qty = 50 ;
...
// counter 
    ...
    while($i < $NumOfAdmins ){
       ...
       if($ii == $NumOfAdmins ){
        ...
        $res3 = mysqli_query($conn,"INSERT INTO `employees`(`fk_aid`, `name`, `uname`, `password`) VALUES ('$adminsID[$idC]','$EmpNames[$iii]','$EmpUnames[$iii]','$pass')");
       ...
       $res3 = mysqli_query($conn,"INSERT INTO `items` (`fk_aid`, `name`, `location`, `qty`, `Dsc`) VALUES ('$adminsID[$idC]','$ItemNames[$iii]','$loc[$iii]','$Qty','$Dsc[$iii]')");
